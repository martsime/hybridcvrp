...
//     #[rstest]
//     fn test_evaluate_individual_one(context_one: Context, mut individual_one: Individual) {
//         Evaluate::complete(&context_one, &mut individual_one);
//         assert_eq!(individual_one.feasible, Some(true));
//         assert_eq!(
//             true,
//             approx_eq!(
//                 f64,
//                 individual_one.penalized_cost(),
//                 433f64,
//                 epsilon = EPSILON
//             )
//         );
//         // 1 is on single route
//         assert_eq!(0, individual_one.predecessor(1));
//         assert_eq!(0, individual_one.successor(1));

//         // 2 is on single route
//         assert_eq!(0, individual_one.predecessor(2));
//         assert_eq!(0, individual_one.successor(2));

//         // 3 is before 4 in a route
//         assert_eq!(0, individual_one.predecessor(3));
//         assert_eq!(4, individual_one.successor(3));

//         // 4 is after 3 in a route
//         assert_eq!(3, individual_one.predecessor(4));
//         assert_eq!(0, individual_one.successor(4));
//     }
// }
